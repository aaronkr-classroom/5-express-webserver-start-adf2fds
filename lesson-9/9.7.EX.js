...
const port = 3000; // @TODO: 포트 번호를 지정한다
    ...
    homeController = require('// @TODO: homeController 모듈을 가져온다
...
app.get("/users/:username", homeController.sendVegParam); // @TODO: "/users/:username"로의 GET 요청 처리 (추가)
app.get("/courses/:courseld", homeController.sendVegParam); // @TODO: "/courses/:courseId"로의 GET 요청 처리 (추가)

/**
 * 다른 라우트 수정
 */
app.get("/about" homeController.getHome); // @TODO: homeController에서 getHome을 가져와 사용한다
